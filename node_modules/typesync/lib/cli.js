            ...
            switch (_a.label) {
                case 0:
                    ...
                    container = (0, awilix_1.createContainer)({
                        ...
                        typeDefinitionSource: (0, awilix_1.asFunction)(type_definition_source_1.createTypeDefinitionSource).singleton(),
...
function run(syncer) {
    return __awaiter(this, void 0, void 0, function () {
        var _a, args, flags, _b, filePath, result, syncedFilesOutput, totals;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    ...
                    C.log((0, chalk_1.default)(templateObject_1 || (templateObject_1 = __makeTemplateObject(["TypeSync v{white ", "}"], ["TypeSync v{white ", "}"])), require('../package.json').version));
                    if (flags.dry) {
                        C.log('—— DRY RUN — will not modify file ——');
                    }
                    return [4 /*yield*/, C.spinWhile("Syncing type definitions in ".concat(chalk_1.default.cyan(filePath), "..."), function () { return syncer.sync(filePath, flags); })];
                case 1:
                    result = _c.sent();
                    ...
                    C.success(totals.newTypings === 0
                        ? "No new typings added, looks like you're all synced up!".concat(totals.removedTypings > 0
                            ? (0, chalk_1.default)(templateObject_2 || (templateObject_2 = __makeTemplateObject([" {gray.italic Also removed ", " unused typings, no big deal.}"], [" {gray.italic Also removed ", " unused typings, no big deal.}"])), totals.removedTypings.toString()) : '')
                        : (0, chalk_1.default)(templateObject_4 || (templateObject_4 = __makeTemplateObject(["", " new typings added", ".\n\n", "\n\n\u2728  Go ahead and run {green npm install} or {green yarn} to install the packages that were added."], ["", " new typings added", ".\\n\\n", "\\n\\n\u2728  Go ahead and run {green npm install} or {green yarn} to install the packages that were added."])), totals.newTypings.toString(), totals.removedTypings > 0
                            ? (0, chalk_1.default)(templateObject_3 || (templateObject_3 = __makeTemplateObject([" {italic (", " unused removed)}"], [" {italic (", " unused removed)}"])), totals.removedTypings.toString()) : '', syncedFilesOutput));
                    return [2 /*return*/];
            }
        });
    });
...
function renderTypeDef(typeDef, isLast) {
    var treeNode = isLast ? '└─' : '├─';
    return (0, chalk_1.default)(templateObject_9 || (templateObject_9 = __makeTemplateObject(["", " ", " {gray @types/}", ""], ["", " ", " {gray @types/}", ""])), treeNode, typeDef.action === 'add' ? (0, chalk_1.default)(templateObject_5 || (templateObject_5 = __makeTemplateObject(["{green.bold +}"], ["{green.bold +}"]))) : (0, chalk_1.default)(templateObject_6 || (templateObject_6 = __makeTemplateObject(["{red.bold -}"], ["{red.bold -}"]))), typeDef.action === 'add'
        ? (0, chalk_1.default)(templateObject_7 || (templateObject_7 = __makeTemplateObject(["{bold.blue ", "}"], ["{bold.blue ", "}"])), typeDef.typingsName) : (0, chalk_1.default)(templateObject_8 || (templateObject_8 = __makeTemplateObject(["{bold.yellow ", "} {gray.italic (unused)}"], ["{bold.yellow ", "} {gray.italic (unused)}"])), typeDef.typingsName));
}
/**
...
function renderSyncedFile(file) {
    var badge = file.newTypings.length === 0 && file.removedTypings.length === 0
        ? (0, chalk_1.default)(templateObject_10 || (templateObject_10 = __makeTemplateObject(["{blue.bold (no new typings added)}"], ["{blue.bold (no new typings added)}"]))) : (0, chalk_1.default)(templateObject_11 || (templateObject_11 = __makeTemplateObject(["{green.bold (", " new typings added, ", " unused typings removed)}"], ["{green.bold (", " new typings added, ", " unused typings removed)}"])), file.newTypings.length.toString(), file.removedTypings.length.toString());
    var dirName = path.basename(path.dirname(path.resolve(file.filePath)));
    var title = (0, chalk_1.default)(templateObject_12 || (templateObject_12 = __makeTemplateObject(["\uD83D\uDCE6 ", " {gray.italic \u2014 ", "} ", ""], ["\uD83D\uDCE6 ", " {gray.italic \u2014 ", "} ", ""])), file.package.name || dirName, file.filePath, badge);
    var nl = '\n';
    var combined = __spreadArray(__spreadArray([], file.newTypings.map(function (t) { return (__assign(__assign({}, t), { action: 'add' })); }), true), file.removedTypings.map(function (t) { return (__assign(__assign({}, t), { action: 'remove' })); }), true);
    var rendered = title +
        nl +
        combined
